...
for y in range(1,21):
        ...
        cur.execute("""INSERT INTO event (datum, ime, prizorisce) VALUES (%s, %s, %s)""",(date, row[1], int(row[2])))
...
for y in range(1,59):
		...
		# ce bi vrednost potlacili v bazo, ne bi nic zakodirali) in izpisemo
                row.append(vrednost)
        #print(row)
        cur.execute("""INSERT INTO model (znamka, lastnik, vrsta_glasbila, za_izposojo)
...
for y in range(1,101):
        ...
        cur.execute("""INSERT INTO glasbenik (uporabnisko_ime, ime, priimek, spol, e_mail, leto_rojstva)
        VALUES (%s, %s, %s, %s, %s, %s)""",
...
for y in range(1,75):
		...
		# ce bi vrednost potlacili v bazo, ne bi nic zakodirali) in izpisemo
                row.append(vrednost)
        #print(row)
        cur.execute("""INSERT INTO clani_skupine (skupina, clan)
        VALUES (%s,%s)""",(row[0],row[1]))
